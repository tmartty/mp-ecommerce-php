...
<body class="as-theme-light-heroimage">
    ...
    <script>
        console.log('=========== INIT MERCADOPAGO')
        // Get preference id
        const preferenceId = document.getElementById('mercadopago-preference-id').value
        console.log('preference id:', preferenceId)
        // Agrega credenciales de SDK
        const mp = new MercadoPago('APP_USR-4bb21c81-be79-4798-9c74-c9ce48f7eaef', {
            locale: 'es-AR'
        });
